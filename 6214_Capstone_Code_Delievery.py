...
df_Imp = pd.DataFrame(df[['treatment', 'log_revenue', 'log_sessions', 'days_first_purchase',
                          'days_first_promo_offer', 'days_first_promo_purchase']])
df_Imp['days_till_fist_promo_purchase'] = df_Imp.days_first_promo_purchase - df_Imp.days_first_promo_offer
df['days_till_fist_promo_purchase'] = df.days_first_promo_purchase - df.days_first_promo_offer

# Robustness Check
df['Impulsiveness'] = ''
df['Impulsiveness'] =df.revenue/df.purchases * (df.days_till_fist_promo_purchase+1)
